            ...
            <div className="space-y-5">
              <div className="space-y-4">
                <div>
                  ...
                  <input type="text" name="name" value={data.name} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-white focus:outline-none focus:border-red-500 transition-colors" />
                </div>
                
                <button 
                    onClick={syncPhotoFromSheet}
                    disabled={isSyncing}
                    className="flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 text-white text-xs font-bold py-3 w-full rounded-lg transition-colors border border-slate-500"
                  >
                ...
                <div>
                  ...
                  <input type="text" name="product" value={data.product} onChange={handleChange} className="w-full bg-slate-900 border border-slate-600 rounded-lg p-3 text-white focus:outline-none focus:border-red-500 transition-colors" />
                </div>
              ...
              <div className="bg-slate-700/30 p-3 rounded-lg border border-slate-600">
                <label className="block text-[10px] font-bold uppercase text-slate-300 mb-2 tracking-wider flex items-center gap-2">
                  <Layout className="w-3 h-3" /> 自訂底圖設定
                </label>
                {!data.bgImage ? (
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase text-slate-300 mb-2 tracking-wider flex items-center gap-2">
                  <ImageIcon className="w-3 h-3" /> 手動人像上傳
                </label>
                {!data.image ? (
                  ...
                  <div className="relative w-full h-24 rounded-lg overflow-hidden border border-white/30 group">
                    ...
                    <button onClick={removeImage} className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
